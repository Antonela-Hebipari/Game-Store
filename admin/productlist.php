...
$path="../forms/ProductImages2/$picture";
                     ...
                     <?php 
                      ...
                      $stmt= $con->prepare($query);
                        ...
                        while(list($image, $image_name, $product_id, $product_name, $description, $price)=$stmt->fetch(PDO::FETCH_BOTH))
                        {
                          ...
                          file_put_contents('../forms/ProductImages2/'.$image_name, base64_decode($encodedData));

                          echo "<tr><td> <img src='../forms/ProductImages2/$image_name' style='width:50px; height:50px; border:groove #000'> </td><td>$product_id</td> <td>$product_name</td> <td>$description</td> <td>$price</td>
                        <td>
